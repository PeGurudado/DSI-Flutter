...
class Professor {
  ...
  Professor({this.id, this.matricula, this.salario, this.telefone, this.pessoa});
  ...
  Map<String, dynamic> toJson() => {'matricula': matricula, 'salario': salario, 'telefone': telefone};
}

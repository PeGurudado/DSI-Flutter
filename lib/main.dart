...
class MeuApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyPage(title: 'A minha tela do BSI'),
    );
  }
}
      ...
      appBar: AppBar(
        title: Row(
          children: <Widget>[
            Text(widget.title),
            Spacer(),
            Image(image: AssetImage('images/logo/bsi-black.png'), height: 30),
          ],
        ),
      ),
      body: Padding(
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              FlatButton(
                onPressed: _IrParaContador,
                color: Colors.red,
                child: Text(
                  'IR PARA O MELHOR CONTADOR',
